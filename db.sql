...
CREATE TABLE attendance_records (
    ...
    status ENUM('SUCCESS', 'PENDING_REVIEW', 'FAILED_INVALID_QR', 'FAILED_DISTANCE', 
                'FAILED_DUPLICATE_DEVICE', 'FAILED_ALREADY_CHECKED', 'FAILED_FACE_VERIFICATION',
                'FAILED_IMAGE_UPLOAD', 'GPS_POOR_SIGNAL', 'ABSENT', 'LATE') NOT NULL DEFAULT 'ABSENT',
